    ...
    apis: [
        {
            ...
            rows: [
                ...
                { attribute: 'size', isRequired: false, type: ['number'], default: '378', version: '1.0.0', description: 'Width or height (depends on placement) of drawer' },
                { attribute: 'type', isRequired: false, type: ['default', 'cloud'], default: 'default', version: '1.0.0', description: 'Drawer view variants' },
                { attribute: 'placement', isRequired: false, type: ['top', 'bottom', 'left', 'right'], default: 'right', version: '1.0.0', description: 'Placement of drawer' },
                { attribute: 'onWrapperClick', isRequired: false, type: ['(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => void'], default: undefined, version: '1.0.0', description: 'Wrapper on click event' },
