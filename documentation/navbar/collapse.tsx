...
import { Text, Navbar, NavbarContent, NavbarItem, NavbarLink, styled, NavbarCollapse, NavbarCollapseLink, NavbarToggle, Radio } from "reactiumui";
...
const ExampleCollapse: React.FunctionComponent = () => {
