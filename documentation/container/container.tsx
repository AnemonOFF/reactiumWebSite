    ...
    apis: [
        {
            ...
            rows: [
                apiRows['children'],
                { attribute: 'fixed', isRequired: false, type: ['boolean'], default: 'false', version: '1.0.0-beta.1', description: 'Container won`t adapt to media width'},
                { attribute: 'center', isRequired: false, type: ['boolean'], default: 'false', version: '1.0.0-beta.1', description: 'Center container across parent width'},
                { attribute: 'position', isRequired: false, type: ['Position'], default: undefined, version: '1.0.0-beta.1', description: 'Set css position attribute. \'Fixed-overflow\' used to prevent pushing out of screen bounds fixed containers'},
                { attribute: 'preventOverScreen', isRequired: false, type: ['boolean'], default: 'false', version: '1.0.0-beta.1', description: 'Used to prevent pushing out of screen bounds fixed and absolute containers'},
                ...apiBreakpointsRows,
                apiRows['hideOnMedia'],
                apiRows['showOnMedia'],
                apiRows['hideScroll'],
