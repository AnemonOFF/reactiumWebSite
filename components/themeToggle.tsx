...
const ThemeToggle: React.FunctionComponent = () => {
    ...
    return (
        <StyledButton onClick={changeTheme}>
            ...
            viewBox="0 0 279.682 279.682" xmlSpace="preserve">
                <g>
                    <path fill="white" d="M143.25,55.486c-41.06,0-74.465,33.405-74.465,74.465c0,16.824,5.511,32.711,15.938,45.939
                    ...
                    <path fill="white" d="M161.766,239.564h-37.041c-7.995,0-14.5,6.505-14.5,14.5v11.117c0,7.995,6.505,14.5,14.5,14.5
                        ...
                        h36.041V264.682z"/>
                    <path fill="white" d="M143.245,45.779c4.143,0,7.5-3.357,7.5-7.5V7.5c0-4.143-3.357-7.5-7.5-7.5
                        c-4.143,0-7.5,3.357-7.5,7.5v30.779C135.745,42.422,139.103,45.779,143.245,45.779z"/>
                    <path fill="white" d="M241.917,34.598c-2.858-2.995-7.606-3.106-10.604-0.248l-22.77,21.73
                    ...
                    <path fill="white" d="M264.273,109.599c-0.004,0-0.008,0-0.012,0l-29.311,0.047c-4.143,0.007-7.495,3.37-7.488,7.512
                    ...
                    <path fill="white" d="M74.386,64.684c2.859-2.996,2.749-7.743-0.248-10.604l-22.77-21.73
                    ...
                    <path fill="white" d="M44.729,109.646l-29.31-0.047c-0.004,0-0.008,0-0.012,0c-4.137,0-7.493,3.351-7.5,7.488
